function [Q, Q_dot, Q_dot2] = cin_inv_traiettoria(S,S_dot,S_dot2,J,J_dot,init,L,limiti_min,limiti_max)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Funzione che calcola la cinematica inversa relativa a una traiettoria
    %
    % [Q, Q_dot, Q_dot2] = cin_inv_traiettoria(S,S_dot,S_dot2,J,J_dot,init,L,limiti_min,limiti_max)
    %
    % Input :
